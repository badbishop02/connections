    ...
    <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12">
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
                    ...
                    <button
                       className="transition duration-500 ease hover:bg-black-500 inline-block bg-purple-600 text-lg rounded-full text-white px-8 py-3 cursor-pointer openModalBtn"
                        onClick={() => {
                        setModalOpen(true);
                        }}
                    >
